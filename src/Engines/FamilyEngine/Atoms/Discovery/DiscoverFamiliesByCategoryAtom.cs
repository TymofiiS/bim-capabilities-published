...
/// <summary>
/// Discovers families by category through the adapter family provider.
/// </summary>
public sealed class DiscoverFamiliesByCategoryAtom : IFamilyDiscoveryAtom
{
    public const string DiscoveryAtomId = "family.discovery.by-category";
